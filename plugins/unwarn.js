let handler = async (m, { conn, args }) => {
    ...
    m.reply('Kamu telah di Unwarn oleh MODERATOR, sekarang kamu memiliki *' + (global.db.data.users[mention].warn * 1) + '* WARN', mention)
}
